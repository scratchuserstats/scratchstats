...
function showProjectStats(){
        document.getElementById("mostViewed").innerHTML = "<center><a href='https://scratch.mit.edu/projects/"+mostViewedID+"/' class='projTitle' target='blank'>"+mostViewedTitle+"</a></center><table style='margin:0px;padding:0px;'><td style='margin:0px;padding:0px;'><img style='display:inline; width:132px;height:96px;'src='"+mostViewedImg+"'></img></td>&nbsp;<td style='margin:0px;padding:0px;'><ul class='statistics' style='top:0px;padding:0px;list-style-type:none;display:inline-block;font-size:15px;'><li class='statistics'>💖"+mostViewedLoves+"</li><li class='statistics'>⭐"+mostViewedFaves+"</li><li class='statistics'>👍"+mostViewedLikes+"%</li><li class='statistics' style='color:red;'>👁️"+mostViewedNum+"</li><li class='statistics'>💬"+mostViewedComments+"</li></ul></td></table>";
        document.getElementById("mostCommented").innerHTML = "<center><a href='https://scratch.mit.edu/projects/"+mostCommentedID+"/' class='projTitle' target='blank'>"+mostCommentedTitle+"</a></center><table style='margin:0px;padding:0px;'><td style='margin:0px;padding:0px;'><img style='display:inline; width:132px;height:96px;'src='"+mostCommentedImg+"'></img></td>&nbsp;<td style='margin:0px;padding:0px;'><ul  class='statistics' style='top:0px;padding:0px;list-style-type:none;display:inline-block;font-size:15px;'><li class='statistics'>💖: "+mostCommentedLoves+"</li><li class='statistics'>⭐: "+mostCommentedFaves+"</li><li class='statistics' style='color:red;'>💬: "+mostCommentedNum+"</li><li class='statistics'>👁️: "+mostCommentedViews+"</li><li class='statistics'>👍: "+mostCommentedLikes+"%</li><li class='statistics'></li></ul></td></table>";
        document.getElementById("mostLiked").innerHTML = "<center><a href='https://scratch.mit.edu/projects/"+mostLikedID+"/' class='projTitle' target='blank'>"+mostLikedTitle+"</a></center><table style='margin:0px;padding:0px;'><td style='margin:0px;padding:0px;'><img style='display:inline; width:132px;height:96px;'src='"+mostLikedImg+"'></img></td>&nbsp;<td style='margin:0px;padding:0px;'><ul class='statistics' style='top:0px;padding:0px;list-style-type:none;display:inline-block;font-size:15px;'><li class='statistics' >💖: "+mostLikedLoves+"</li><li class='statistics'>⭐: "+mostLikedFaves+"</li><li class='statistics'>💬: "+mostLikedComments+"</li><li class='statistics'>👁️: "+mostLikedViews+"</li><li class='statistics' style='color:red;'>👍: "+mostLikedNum+"%</li><li class='statistics'></li></ul></td></table>";
        document.getElementById("mostLoved").innerHTML = "<center><a href='https://scratch.mit.edu/projects/"+mostLovedID+"/' class='projTitle' target='blank'>"+mostLovedTitle+"</a></center><table style='margin:0px;padding:0px;'><td style='margin:0px;padding:0px;'><img style='display:inline; width:132px;height:96px;'src='"+mostLovedImg+"'></img></td>&nbsp;<td style='margin:0px;padding:0px;'><ul class='statistics'style='top:0px;padding:0px;list-style-type:none;display:inline-block;font-size:15px;'><li class='statistics' style='color:red;'>💖: "+mostLovedNum+"</li><li class='statistics'>⭐: "+mostLovedFaves+"</li><li class='statistics'>💬: "+mostLovedComments+"</li><li class='statistics'>👁️: "+mostLovedViews+"</li><li class='statistics'>👍: "+mostLovedLikes+"%</li><li class='statistics'></li></ul></td></table>";
}
