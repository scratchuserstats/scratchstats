...
function showProjectStats(){
        document.getElementById("mostViewed").innerHTML = "<center><a href='https://scratch.mit.edu/projects/"+mostViewedID+"/' class='projTitle' target='blank'>"+mostViewedTitle+"</a></center><table style='margin:0px;padding:0px;'><td style='margin:0px;padding:0px;'><img style='display:inline; width:132px;height:96px;'src='"+mostViewedImg+"'></img></td>&nbsp;<td style='margin:0px;padding:0px;'><ul class='statistics' style='top:0px;padding:0px;list-style-type:none;display:inline-block;font-size:15px;'><li class='statistics'>💖: "+mostViewedLoves+"</li><li class='statistics'>⭐: "+mostViewedFaves+"</li><li class='statistics'>💬: "+mostViewedComments+"</li><li class='statistics' style='color:red;'>👁️: "+mostViewedNum+"</li><li class='statistics'>👍: "+mostViewedLikes+"%</li><li class='statistics'></li></ul></td></table>";
